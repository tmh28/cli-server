/**
 * Created by wuxueyong on 17/7/14.
 */
...
export const addComment=params=>{
  return axios.get(config.addComment,{params:params});
}
/*修改民主评议*/
...
/*export const getintegralRule=params=>{
  return axios.get(config.getIntegralRule,{params:params});
}*/


//管理员
export const login=params=>{
  return axios.get(config.login,{params:params})
}
export const logout=()=>{
...
export  const setUserState=(data)=>{
  return axios.get(config.setUserState,{params:data});
}
